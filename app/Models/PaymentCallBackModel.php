...
{
    protected $table      = 'tb_payment_callback'; // Nama tabel
    protected $primaryKey = 'id'; // Primary Key
    protected $protectFields = false;
        //protected $allowedFields = ['name', 'email', 'age']; // Kolom yang boleh diisi
    protected $useTimestamps = true;
    protected $columnOrder = [null, 'transaction_status','payment_type','order_id','va_number','url']; // Fields for ordering
    protected $columnSearch = ['transaction_status','payment_type','order_id','va_number','url']; // Fields for search
