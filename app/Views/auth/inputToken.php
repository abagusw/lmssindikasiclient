...
<head>
  ...
  <link href="<?= base_url() ?>compo_notif/jquery.ambiance.css" rel="stylesheet">
...
<body>
  ...
  <div class="container">
    <div class="card-wrapper shadow rounded-corner">
      ...
      <!-- Logo -->
      <img src="<?= base_url() ?>login/logo_sindikasi.png" alt="Logo Sindikasi" class="logo">
      <br>

      <!-- Icon -->
      <img src="<?= base_url() ?>login/connection.png" alt="Icon Token" class="icon-img">
  ...
  <script src="<?= base_url() ?>compo_notif/jquery.ambiance.js"></script>
