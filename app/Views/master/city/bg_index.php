...
<div class="row">
  <div class="col-lg-12">
    <div class="d-flex justify-content-start mb-3">
      <a href="<?= base_url() ?>master/add_city" class="btn btn-success btn-sm"><i class='bi bi-add me-1'></i>Tambah Data</a>
    </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class='d-flex gap-2'>
                        ...
                        <a href='#!' class='btn btn-sm btn-danger' data-bs-toggle='modal' data-bs-target='#deleteModal'  onclick='confirmDeleteCity(".$data['id'].")'>
