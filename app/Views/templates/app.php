...
<html lang="en">
  ...
  <head>
    ...
    <title>Membership Indikasi App</title>
    ...
    <link rel="stylesheet" href="<?= ASSETS_URL_ADMIN ?>assets_admin/css/adminlte.css" />
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="<?= ASSETS_URL_ADMIN ?>assets_admin/assets/img/user2-160x160.jpg"
                  class="user-image rounded-circle shadow"
                  alt="User Image"
                />
                <span class="d-none d-md-inline"><?= $user_logged_in['nama']; ?></span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    <?= $user_logged_in['nama']; ?> - Web Developer
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="<?= base_url() ?>" class="brand-link">
            <!--begin::Brand Image-->
            <img
              src="<?= base_url() ?>public/assets/images/logo-sm.png"
              alt="Logo"
              class="brand-image opacity-75 shadow"
            />
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">LMS Dashboard</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.select2').select2({ // jika pakai tema Bootstrap 5 (opsional)
