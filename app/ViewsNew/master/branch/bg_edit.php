  ...
  <div class="col-lg-12">
    <div class="card card-primary card-outline mb-4">
      ...
      <div class="card-header">
        <div class="card-title">Edit Master Branch</div>
      </div>
      ...
      <form id="formAddDataMaster">
        ...
        <div class="card-body">
          <div class="mb-3">
            ...
            <input type="hidden" class="form-control" id="id" name="id" value="<?= $getData['id']?>" required />
            <input type="text" class="form-control" id="nama" name="nama" value="<?= $getData['name']?>" required />
          </div>
        </div>
        <!--end::Body-->
        <!--begin::Footer-->
...
$('#formAddDataMaster').submit(function(e){
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('master/simpanEditBranch')?>",
            async: false,
            dataType: 'JSON',
            contentType: false,
            processData: false,
